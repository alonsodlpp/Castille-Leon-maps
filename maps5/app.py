...
mapa_cyl = "maps5/au.muni_cyl_recintos_comp.shp"
...
def seleccionar_elecciones(elecciones):
    if elecciones == "Elecciones generales noviembre de 2019":
        cyl_datos = pd.read_excel("maps5/CyL.xlsx", sheet_name="CyL noviembre 2019")
    elif elecciones == "Elecciones autonómicas mayo de 2019":
        cyl_datos = pd.read_excel("maps5/CyL.xlsx", sheet_name="CyL mayo 2019")
    else:
        cyl_datos = pd.read_excel("maps5/CyL.xlsx", sheet_name="CyL abril 2019")
